...
function Project({
  ...
  return (
    <article className=" group relative flex flex-col items-center bg-gray-200/20 hover:bg-gray-300/20 dark:bg-gray-600/20 dark:hover:bg-gray-600/40 transition rounded-lg sm:items-start lg:max-w-5xl overflow-hidden sm:pr-8 w-full h-[35rem] sm:h-[37rem] md:h-[32rem] lg:h-[27rem] gap-16 lg:odd:pl-[7rem]">
