...
export default function ContactPage() {
  ...
  return (
    <section
      ref={ref}
      className="flex flex-col items-center justify-center gap-4 py-8 md:py-10 scroll-mt-0 h-svh"
      id="contact"
    >
      ...
      >
        ...
        />
        <Button
          className={`${buttonStyles({ variant: "solid", radius: "md" })} max-w-sm sm:max-w-sm lg:max-w-sm`}
          type="submit"
        >
          Submit <FaPaperPlane />
        </Button>
